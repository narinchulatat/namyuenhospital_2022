    ...
    <div class="row">
        ...
        <div class="ui one column grid">
          <div class="column">
            <!-- <div class="ui raised segment"> -->
              <h4><span class="glyphicon glyphicon-briefcase"></span>&nbsp;ข่าวรับสมัครงาน</h4>
                <hr \>
                    <?php
      ...
      <div class="col-md-6">
        <div class="ui one column grid">
          <div class="column">
            <!-- <div class="ui raised segment"> -->
              <h4><span class="fa fa-paper-plane"></span>&nbsp;ข่าวจัดซื้อจัดจ้าง</h4>
                <hr \>
              <?php
              echo ListView::widget([
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="ui one column grid">
          <div class="column">
            <!-- <div class="ui raised segment"> -->
              <h4><span class="fa fa-lightbulb-o"></span>&nbsp;บทความสาระน่ารู้ล่าสุด</h4>
                <hr \>
              <?php
              echo ListView::widget([
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="ui one column grid">
          <div class="column">
            <!-- <div class="ui raised segment"> -->
              <h4><span class="fa fa-calendar"></span>&nbsp;อัลบั้มภาพ</h4>
              <hr \>
              <p></p>
